> **This is the ORIGINAL README from the upstream project we copied
> (https://github.com/ublue-os/image-template), kept here for reference only.**
>
> It is written for experienced Linux users and it describes the *template*, not
> AquariusOS. Some of it no longer matches our repo (we renamed things — see
> ../README.md for the list of differences).
>
> **Royce: you want ../GETTING-STARTED.md instead. Read that one.**
> This file is here so we can look up how the machinery works when we need to.
