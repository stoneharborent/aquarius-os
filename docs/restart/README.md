...
| ~~A second handheld: the MSI Claw 8 AI+~~ | **shipped in G4** (2026-09-20) as a FOURTH image, `aquarius-os-handheld-claw` — round one, on Fedora's kernel 7.2, with the paddles and the power slider honestly marked as waiting for kernel 7.3 — see [`handheld-claw.md`](handheld-claw.md) |
...
- **⚠️ The Claw handheld image — what `aquarius-os-handheld-claw` is, how to install it on the MSI Claw 8 AI+ (including the three things you can only do IN WINDOWS first, one of which is setting the controller to XInput), what works today on kernel 7.2, what waits for kernel 7.3, `aq handheld status`, and the bench list:** [`handheld-claw.md`](handheld-claw.md)
